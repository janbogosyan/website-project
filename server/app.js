...
//console.log(req.body) bqhme izpolzvali v nachaloto pri app.use('/product',(req,res,next))...., i chrez body-parser shte vidim rezultata v konzolata bez nego nqma da go pokaje sushto taka..

const app = express(); //imeto e po izbor 

const controllerForError = require('./controllers/error');

//for template engine
app.set('view engine', 'ejs'); //you can't pass variables/values to pure html. The templating engine is something that looks at the data you pass and generates the html markup for you. and using pug which is templat eengine for express
...
app.use(controllerForError.errorController);
